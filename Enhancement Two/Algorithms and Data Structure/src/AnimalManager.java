...
public class AnimalManager {
    ...
    public static void initializeDogList() {
        ...
        Dog dog3 = new Dog("Daisy", "Chihuahua", "female", "4", "25.6", "12-12-2020", "Canada", "in service", false,
                "Canada");
        Dog dog4 = new Dog("Julie", "Labrador", "female", "2", "28.4", "04-18-2022", "United States", "in service",
                false, "United States");
        Dog dog5 = new Dog("Bleu", "Beagle", "male", "3", "22.1", "11-22-2021", "Mexico", "Phase I", false, "Mexico");
        dogList.add(dog1);
        dogList.add(dog2);
        dogList.add(dog3);
        dogList.add(dog4);
    ...
    public static void initializeMonkeyList() {
        ...
        Monkey monkey4 = new Monkey("Zara", "female", "3", "17.2", "03-15-2022", "Brazil", "in service", false,
                "Brazil", 38, 12, 33, "capuchin");
        Monkey monkey5 = new Monkey("Kiko", "male", "2", "15.0", "07-09-2023", "Costa Rica", "Phase I", false,
                "Costa Rica", 36, 10, 30, "tamarin");
